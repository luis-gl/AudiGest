...
def get_csv_elements(parent_dir: str):
    ...
    for content in os.listdir(parent_dir):
        ...
        for name in os.listdir(audio_path):
            ...
            name = name.split('.')[0]
            melspec_file = os.path.join(melspec_path, f'{name}.pt')
            ...
            audio_csv = f'{csv_elements},{name}.wav,{name}.pt,'
            ...
            for frame in os.listdir(audio_lmks_path):
                ...
                mfcc_file = os.path.join(audio_mfcc_path, f'{frame}.pt')
                ...
                if not exist_lmks or not exist_mfcc:
                    ...
                    continue
                csv_line += audio_csv + f'{frame}.npy,{frame}.pt\n'
